...
export const SELECTORS = {
  ...
  PROFILE: {
    EDIT_HEADLINE_BUTTON: {
      primary: 'span.edit.icon',
      fallbacks: [
        'xpath=//span[text()="Resume headline"]//following::span[@class="edit icon"][1]',
        ...
        'span.edit.icon',
        '.edit.icon',
        '.card .widgetHead .edit.icon',
        '.widgetHead span.edit',
        '.resumeHeadline span.edit',
        '#lazyResumeHead span.edit',
        '#lazyResumeHead .edit',
        'span:has-text("editOneTheme")',
        '.widgetHead span',
        '.edit',
        'span.edit',
        'span.icon',
        '.icon',
        'button:has-text(/edit.*headline/i)',
    ...
    CURRENT_HEADLINE: {
      primary: '.prefill.typ-14Medium',
      fallbacks: [
        'xpath=//span[text()="Resume headline"]//following::div[contains(@class,"prefill")]',
        '.prefill.typ-14Medium div',
        '#lazyResumeHead .widgetCont .prefill.typ-14Medium div',
        '.resumeHeadline .widgetCont .prefill.typ-14Medium div',
        '.resumeHeadline .prefill.typ-14Medium div',
        '#lazyResumeHead .prefill.typ-14Medium div',
        '.widgetCont .prefill.typ-14Medium div',
        '.card .widgetCont .prefill.typ-14Medium div',
        '#lazyResumeHead .widgetCont div',
        '.resumeHeadline .widgetCont div',
        '.widgetCont .prefill div',
        '.prefill div',
        '.widgetCont div',
        '.card .widgetCont div',
        '.card .prefill div',
        ...
        '.card div div',
        '.prefill',
        'div:has-text("Senior Software")',
        'div:has-text("automation testing")',
        '.resumeHeadline .widgetHead',
